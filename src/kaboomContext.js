...
export const k = kaboom({
    ...
    height : 360 * scale,
    scale,
    letterbox : true, // the screen is responsive
    global : false,
});

k.loadFont("glyph", "/assets/glyphmesss.ttf");
...
k.loadSpriteAtlas("/assets/ui.png", { // loadSpriteAtlas with this we are cutting a certain portion of the image    
    healthBar : { // we cut the healthBar sprite
        x : 16, // start of image
        y : 16, // start of image
        width : 60, // cut from start
        height : 48, // cut from start
        sliceY : 3 
    },
});
